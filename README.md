...
Safety-first local Mission Control for OpenClaw.
...
<img src="docs/assets/overview-en.png" alt="OpenClaw Mission Control overview screenshot" width="900" />

<img src="docs/assets/usage-en.png" alt="OpenClaw Mission Control usage screenshot" width="900" />
...
```text
You are helping me connect OpenClaw Mission Control to this machine's OpenClaw installation.
...
```text
你现在要帮我把 OpenClaw Mission Control 接到这台机器自己的 OpenClaw 环境上。
